 ...
 * @LastEditTime: 2023-09-14 01:14:47
...
private:
    ...
    const int           STATE_DIM_      =   STATE_DIM;      /* 状态维数 */
    const int           NOISE_DIM_      =   NOISE_DIM;      /* 噪声维数 */
    const int           GPOS_OBS_DIM_   =   GPOS_OBS_DIM;   /* GNSSpos观测维数 */
    /* Imu队列最大长度 */
    const int           IMU_DEQUE_NUM_  =   IMU_SAMPLE_FRQ * IMU_DEQUE_TIME;
    /* GPOS队列最大长度 */
    const int           GPOS_DEQUE_NUM_ =   GPOS_SAMPLE_FRQ * GPOS_DEQUE_TIME;
    
    enum StateID { P_ID = 0, V_ID = 3, PHI_ID = 6, BG_ID = 9, BA_ID = 12, SG_ID = 15, SA_ID = 18 };
    enum NoiseID { ARW_ID = 0, VRW_ID = 3, BGSTD_ID = 6, BASTD_ID = 9, SGSTD_ID = 12, SASTD_ID = 15 };
